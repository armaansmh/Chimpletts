...
const FAQs = () => {
    ...
    return (
        <div style={{
            ...
            <h1 className="text-center lg:text-4xl text-2xl lg:leading-9 leading-7 font-semibold mb-9 underline">FAQ's</h1>
            <div style={{
                ...
                <div className="w-full md:px-6  " onClick={() => setOpen4(!open4)} >
                    ...
                    <div id="menu" className={"mt-6 w-full " + (open4 ? "block" : "hidden")}>
                        <p className="text-base leading-6 text-left text-white font-normal">5th March 7PM UTC on <a href="monkelabs.io" className="font-bold unerline">monkelabs.io</a> </p>
                    </div>
                </div>
