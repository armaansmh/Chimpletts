            ...
            <div style={{
                ...
                <div className="w-full md:px-6  " onClick={() => setOpen4(!open4)} >
                    ...
                    <div id="menu" className={"mt-6 w-full " + (open4 ? "block" : "hidden")}>
                        <p className="text-base leading-6 text-left text-white font-normal">5th March 7PM UTC on <a href="monkelabs.io" className="text-3xl unerline">monkelabs.io</a> </p>
                    </div>
                </div>
