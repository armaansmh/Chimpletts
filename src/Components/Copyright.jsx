  ...
  return (
    <div style={{
        ...
        <div className="flex gap-6 items-center  justify-center">
          ...
          <i className="fa-brands fa-discord text-3xl text-white hover:scale-125 transition-all">

          </i>
          </a>
          <a href="https://www.twitter.com/TheChimpetts/" target="_blank">

          <i className="fa-brands fa-twitter text-3xl text-white hover:scale-125 transition-all">
